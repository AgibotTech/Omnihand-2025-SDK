 ...
 * @LastEditTime: 2025-11-10 17:09:37
...
#include "src/implementation/c_agibot_hand_can/c_agibot_hand_can.h"
...
class OmniHandProNode : public rclcpp::Node {
 ...
 private:
  ...
  rclcpp::Subscription<omnihand_pro_node_msgs::msg::MixControl>::SharedPtr mix_control_subscriber_;
