...
class AgibotHandO12:
    def __init__(self, device_id: int = 1, hand_type: EHandType =  EHandType.LEFT) -> None: ...
    ...
    # Angle control
    # def set_joint_angle(self, joint_motor_index: int, angle: float) -> None: ...
    # def get_joint_angle(self, joint_motor_index: int) -> float: ...
    def set_all_joint_angles(self, vec_angle: List[float]) -> None: ...
